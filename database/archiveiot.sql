...
--
-- Host: localhost
-- Generation Time: Aug 13, 2024 at 12:26 PM
...
(2, '172344432966b9ac6959c3e', 1, 3, 'Have you seen the last post lately', '../public/src/src_172344432966b9ac6958d34.png', '2024-08-12 06:32:09', '2024-08-12 06:32:09'),
...
(1, '172244145866aa5ef2d25b7', 'Joseph Emmanuel', 'opcode3@gmail.com', '$2y$10$kvJrC2aKYTK8fOkC98nPIOOpbsbLo8VhcZZ.0vr7cQzI3UDNLXXJG', '../public/src/src_172258513766ac903143811.jpg', '2024-07-31 15:57:38', '2024-08-02 08:52:17'),
...
--
ALTER TABLE `engages_tb`
  MODIFY `engage_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;

--
-- AUTO_INCREMENT for table `notifications_tb`
--
ALTER TABLE `notifications_tb`
  MODIFY `notification_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `threats_tb`
--
ALTER TABLE `threats_tb`
  MODIFY `threat_id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
